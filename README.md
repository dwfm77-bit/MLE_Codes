...
All routines point to the "Datasets" repository, which contains image samples for the different bands along with the revised masks. The routines can be executed locally. For dependencies, refer to the 'requirements.txt' file.

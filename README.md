...
All routines point to the "Datasets" repository, which contains image samples for the different bands along with the revised masks. To access the complete dataset, use the link: https://www.kaggle.com/datasets/danielwander/s2-rd-lite. The routines can be executed locally. For dependencies, refer to the 'requirements.txt' file.
